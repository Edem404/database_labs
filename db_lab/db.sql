...
DROP TABLE IF EXISTS fourth_lab_db.adress;
...
CREATE TABLE IF NOT EXISTS fourth_lab_db.adress (
	id INT NOT NULL AUTO_INCREMENT,
	city_name VARCHAR(45) NOT NULL,
	city_region_name VARCHAR(45) NOT NULL,
	street VARCHAR(45) NOT NULL,
	PRIMARY KEY (id),
    INDEX city_name_street_idx (city_name ASC, street ASC) VISIBLE,
	INDEX fk_adress_city1_idx (city_name ASC, city_region_name ASC) VISIBLE
) engine = InnoDB;

ALTER TABLE fourth_lab_db.adress 
	ADD CONSTRAINT fk_adress_city1
    FOREIGN KEY (city_name , city_region_name)
    REFERENCES fourth_lab_db.city (name , region_name)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
CREATE TABLE IF NOT EXISTS fourth_lab_db.park (
	...
	INDEX fk_park_adress1_idx (adress_id ASC) VISIBLE
) engine = InnoDB;

ALTER TABLE fourth_lab_db.park
	ADD CONSTRAINT fk_park_adress1
    FOREIGN KEY (adress_id)
    REFERENCES fourth_lab_db.adress (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
CREATE TABLE IF NOT EXISTS fourth_lab_db.order_ticket (
  ...
  ticket_park_id INT NOT NULL,
  order_id INT NOT NULL,
  number_of_tickets INT NULL,
  PRIMARY KEY (ticket_id, ticket_park_id, order_id),
  INDEX fk_ticket_has_order_order1_idx (order_id ASC) VISIBLE,
  INDEX fk_ticket_has_order_ticket1_idx (ticket_id ASC, ticket_park_id ASC) VISIBLE,
  INDEX number_of_tickets_tickets_park_id_idx (number_of_tickets ASC, ticket_park_id) VISIBLE
) engine = InnoDB;

ALTER TABLE fourth_lab_db.order_ticket
	ADD CONSTRAINT fk_ticket_has_order_ticket1
    FOREIGN KEY (ticket_id , ticket_park_id)
    REFERENCES fourth_lab_db.ticket (id , park_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
INSERT INTO fourth_lab_db.adress (city_name, city_region_name, street) VALUES
	('Lviv', 'Lviv', 'Lvivska');
    
INSERT INTO fourth_lab_db.park (max_visitors_per_day, open_time, adress_id) VALUES
	(100, '08:00-21:00', 1);
...
INSERT INTO fourth_lab_db.staff (name, surname, phonenumber, park_id) VALUES
	('sname1', 'ssurname1', '+380970000001', 1);
...
INSERT INTO fourth_lab_db.order_ticket (ticket_id, ticket_park_id, order_id, number_of_tickets) VALUES
	(1, 1, 1, 1);
