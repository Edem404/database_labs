...
class AttractionDAO(GeneralDAO):
    ...
    def insert_attraction_has_staff(self, staff_name, staff_surname, attraction_name):
        self._session.execute(sqlalchemy.text("CALL insert_attraction_has_staff(:p1, :p2, :p3)"),
                              {"p1": staff_name, "p2": staff_surname, "p3": attraction_name})
